            ...
            <nav class="bg-blue-600">
                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex-shrink-0">
                        <p className="text-white">Pharmy-app</p>
                    </div>
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                        <a href="#" class="px-3 py-2 rounded-md text-sm font-medium text-white bg-blue-800 focus:outline-none focus:text-white focus:bg-blue-400">Dashboard</a>
